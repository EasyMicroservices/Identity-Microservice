...
namespace Identity.GeneratedServices
{
    ...
    public partial class ResetPasswordClient : EasyMicroservices.Cores.Clients.CoreSwaggerClientBase
    {
        ...
        /// <returns>Success</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual System.Threading.Tasks.Task<GenerateResetPasswordTokenResponseContractMessageContract> GenerateResetPasswordTokenAsync(GenerateResetPasswordTokenRequestContract body)
        {
        ...
        /// <returns>Success</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task<GenerateResetPasswordTokenResponseContractMessageContract> GenerateResetPasswordTokenAsync(GenerateResetPasswordTokenRequestContract body, System.Threading.CancellationToken cancellationToken)
        {
            var urlBuilder_ = new System.Text.StringBuilder();
            ...
            try
            {
                using (var request_ = await CreateHttpRequestMessageAsync(cancellationToken).ConfigureAwait(false))
                {
                    ...
                    try
                    {
                        ...
                        if (status_ == 200)
                        {
                            var objectResponse_ = await ReadObjectResponseAsync<GenerateResetPasswordTokenResponseContractMessageContract>(response_, headers_, cancellationToken).ConfigureAwait(false);
                            if (objectResponse_.Object == null)
                            {
                                throw new ApiException("Response was null which was not expected.", status_, objectResponse_.Text, headers_, null);
                            }
    ...
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "13.19.0.0 (NJsonSchema v10.9.0.0 (Newtonsoft.Json v13.0.3.0))")]
    public partial class GenerateResetPasswordTokenResponseContract : System.ComponentModel.INotifyPropertyChanged
    {
        private string _token;
    ...
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "13.19.0.0 (NJsonSchema v10.9.0.0 (Newtonsoft.Json v13.0.3.0))")]
    public partial class GenerateResetPasswordTokenResponseContractMessageContract : System.ComponentModel.INotifyPropertyChanged
    {
        private bool _isSuccess;
        private ErrorContract _error;
        private SuccessContract _success;
        private GenerateResetPasswordTokenResponseContract _result;
        ...
        [Newtonsoft.Json.JsonProperty("result", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public GenerateResetPasswordTokenResponseContract Result
        {
            get { return _result; }
